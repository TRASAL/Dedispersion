...
int main(int argc, char * argv[]) {
  ...
  std::vector< uint8_t > beamDriverStepOne(observation.getNrSynthesizedBeams() * observation.getNrPaddedChannels(padding / sizeof(uint8_t)));
